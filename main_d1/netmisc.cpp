...
void netmisc_encode_angvec(char* ptr, int* offset, vms_angvec* vec)
{
...
void netmisc_decode_angvec(char* ptr, int* offset, vms_angvec* vec)
{
...
void netmisc_encode_netplayer_info(char* ptr, int* offset, netplayer_info* info)
{
...
void netmisc_decode_netplayer_info(char* ptr, int* offset, netplayer_info* info)
{
	...
	netmisc_decode_int8(ptr, offset, (char*)&info->connected);
...
{
	int i, j;
	netmisc_decode_int8(ptr, offset, (char*)&info->type);
	netmisc_decode_int8(ptr, offset, (char*)&info->protocol_version);
	...
	netmisc_decode_int8(ptr, offset, (char*)&info->gamemode);
	netmisc_decode_int8(ptr, offset, (char*)&info->difficulty);
	netmisc_decode_int8(ptr, offset, (char*)&info->game_status);
	netmisc_decode_int8(ptr, offset, (char*)&info->numplayers);
	netmisc_decode_int8(ptr, offset, (char*)&info->max_numplayers);
	netmisc_decode_int8(ptr, offset, (char*)&info->game_flags);
	for (i = 0; i < MAX_PLAYERS; i++)
	...
	netmisc_decode_int8(ptr, offset, (char*)&info->team_vector);
...
void netmisc_decode_frame_info(char* ptr, int* offset, frame_info* info)
{
	...
	netmisc_decode_int8(ptr, offset, (char*)&info->playernum);
	netmisc_decode_int8(ptr, offset, (char*)&info->obj_render_type);
	netmisc_decode_int8(ptr, offset, (char*)&info->level_num);
...
void netmisc_decode_endlevel_info(char* ptr, int* offset, endlevel_info* info)
{
	int i, j;
	netmisc_decode_int8(ptr, offset, (char*)&info->type);
	netmisc_decode_int8(ptr, offset, (char*)&info->player_num);
	netmisc_decode_int8(ptr, offset, (char*)&info->connected);
	for (i = 0; i < MAX_PLAYERS; i++)
		for (j = 0; j < MAX_PLAYERS; j++)
	...
	netmisc_decode_int8(ptr, offset, (char*)&info->seconds_left);
}
...
void netmisc_decode_object(char* ptr, int* offset, object* objp)
{
	...
	netmisc_decode_int8(ptr, offset, (char*)&objp->type);
	netmisc_decode_int8(ptr, offset, (char*)&objp->id);
	netmisc_decode_int16(ptr, offset, &objp->next);
	netmisc_decode_int16(ptr, offset, &objp->prev);
	netmisc_decode_int8(ptr, offset, (char*)&objp->control_type);
	netmisc_decode_int8(ptr, offset, (char*)&objp->movement_type);
	netmisc_decode_int8(ptr, offset, (char*)&objp->render_type);
	netmisc_decode_int8(ptr, offset, (char*)&objp->flags);
	...
	netmisc_decode_int8(ptr, offset, (char*)&objp->contains_type);
	netmisc_decode_int8(ptr, offset, (char*)&objp->contains_id);
	netmisc_decode_int8(ptr, offset, (char*)&objp->contains_count);
	netmisc_decode_int8(ptr, offset, (char*)&objp->matcen_creator);
	...
	*offset += extra;
	...
	{
	case CT_AI:
		netmisc_decode_int8(ptr, offset, (char*)&objp->ctype.ai_info.behavior);
		for (i = 0; i < MAX_AI_FLAGS; i++)
			netmisc_decode_int8(ptr, offset, (char*)&objp->ctype.ai_info.flags[i]);
	...
	*offset += extra;
	...
	case RT_FIREBALL:
		...
		netmisc_decode_int8(ptr, offset, (char*)&objp->rtype.vclip_info.framenum);
		extra -= 9;
		break;
	}
	*offset += extra;
