...
int do_object_dialog()
{
	...
	snprintf(Xmessage,MATT_LEN,"%.2f",f2fl(obj->mtype.spin_rate.x));
	snprintf(Ymessage,MATT_LEN,"%.2f",f2fl(obj->mtype.spin_rate.y));
	snprintf(Zmessage,MATT_LEN,"%.2f",f2fl(obj->mtype.spin_rate.z));
