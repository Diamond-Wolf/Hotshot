...
#define GFONT_MEDIUM_1  	1 * FONT_INTERLEAVE
#define GFONT_MEDIUM_2	    2 * FONT_INTERLEAVE
#define GFONT_MEDIUM_3	    3 * FONT_INTERLEAVE
#define GFONT_SMALL 		4 * FONT_INTERLEAVE
...
#define HELP_FONT	    	MEDIUM1_FONT
#define MENU_FONT		    MEDIUM1_FONT
#define SCORES_FONT         MEDIUM1_FONT
